...
# pdf_file_path = '/Users/jamesqxd/Documents/norgai-docs/EBA/Woolworths/WW2018.pdf'  
# toc_page = find_toc_page(pdf_file_path)


def to_markdownOOG(doc: fitz.Document, pages: list = None) -> str:
